...
{
    /// <inheritdoc />
    public partial class InitialRealWorldSetup : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Requirements = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    AiPreferredSkills = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AiKeywordsExtracted = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    AiFeedback = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ScreeningNotes = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InterviewerName = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    SkillsScore = table.Column<double>(type: "double", nullable: false),
                    CultureScore = table.Column<double>(type: "double", nullable: false),
                    CommunicationScore = table.Column<double>(type: "double", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "admin@hiretrax.io", "$2a$11$orqYsHOVVwYPdzv5ruqJ7Os.ommONSK1gcjhAf2BYQKXSwYkOLura", 4 });
